...
- **Global scope**: `/Users/prophero/development/how-much-is-this-property-worth/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/prophero/development/how-much-is-this-property-worth/.cursor/notes/`)
...
2. Glob `/Users/prophero/development/how-much-is-this-property-worth/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/prophero/development/how-much-is-this-property-worth/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/prophero/development/how-much-is-this-property-worth/.cursor/notes/` — works in any directory
