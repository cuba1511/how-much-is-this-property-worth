...
```
Agent(
  prompt="Read /Users/prophero/development/how-much-is-this-property-worth/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/prophero/development/how-much-is-this-property-worth/.cursor/get-shit-done/templates/SECURITY.md`
