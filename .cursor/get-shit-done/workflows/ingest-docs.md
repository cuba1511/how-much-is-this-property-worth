...
```bash
INIT=$(node "/Users/prophero/development/how-much-is-this-property-worth/.cursor/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/prophero/development/how-much-is-this-property-worth/.cursor/get-shit-done/bin/gsd-tools.cjs" commit \
