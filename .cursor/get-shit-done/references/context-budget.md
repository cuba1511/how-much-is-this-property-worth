...
The keys live in `.claude/settings.json` (project) or `/Users/prophero/development/how-much-is-this-property-worth/.cursor/settings.json` (global) — **not** in `.planning/config.json`:
